    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_type', models.CharField(choices=[('gps', 'GPS Tracker'), ('obd', 'OBD-II Scanner'), ('eyefleet-hardware', 'eyefleet Hardware')], max_length=50)),
                ('firmware_version', models.CharField(max_length=20)),
                ('assigned_asset', models.TextField(blank=True, null=True)),
