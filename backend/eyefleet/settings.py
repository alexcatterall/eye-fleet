"""
Django settings for eyefleet project.
...
SECRET_KEY = 'django-insecure-ps%dyxxq=4fx*pt!%g!8))u-vh+tgpt+5re+uc5x=t^eqgi#u2'
...
>>>>>>> f7aa69d76455d382ab4a51710fce6b5bb00eea88

# MQTT Configuration
MQTT_BROKER_HOST = os.environ.get('MQTT_BROKER_HOST', 'localhost')
MQTT_BROKER_PORT = int(os.environ.get('MQTT_BROKER_PORT', 1883))
MQTT_TOPIC = 'eyefleet/telemetry'
...
INFLUXDB_TOKEN = os.getenv("INFLUXDB_TOKEN", "test")
INFLUXDB_ORG = os.getenv("INFLUXDB_ORG", "test")
